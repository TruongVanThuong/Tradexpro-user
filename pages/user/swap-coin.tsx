        ...
        <div className="modal-dialog" role="document">
          <div className="modal-content">
            ...
            <div className=" tradex-flex tradex-gap-4 tradex-items-center">
              <button
                type="button"
                className="tradex-w-fit tradex-px-4 tradex-flex tradex-items-center tradex-justify-center tradex-min-h-[36px] tradex-h-9 tradex-py-4 tradex-rounded-lg tradex-bg-red-600 tradex-text-white"
                data-dismiss="modal"
              >
                {t("No")}
              </button>
              <button
                type="button"
                className="tradex-w-fit tradex-px-4 tradex-flex tradex-items-center tradex-justify-center tradex-min-h-[36px] tradex-h-9 tradex-py-4 tradex-rounded-lg tradex-bg-primary tradex-text-white"
                onClick={() => {
                  swapCoinAction(
                    fromSelected.amount,
                    fromSelected.coin_id,
